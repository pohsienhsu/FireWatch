...
Steps 4 and 5 are optional but be needed if the user wants to run the analysis notebooks and view the the complete dataset from years 1992-2015.
The dataset included in this package only contains the fire and aqi data from 1992.
...
4. Observe the Map. Notice the "Analysis Dropdown" and "Discussion and Conclusions" tabs.
   Note that selecting the years from 1993-2015 from the Year drop down is a no-op unless the installation steps 4 and 5 have been run.
